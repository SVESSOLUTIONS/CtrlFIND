...
export const BuyerOrdersScreen = () => {
  ...
  return (
    <>
      <AppHeader title={translate('orders')} isMenu shadow={false} />
      <TouchableOpacity onPress={()=>{
        gettingOrders(title === 'Products' ? index : serviceIndex)
      }} style={{flexDirection:"row",justifyContent:'flex-end',position:'absolute',alignSelf:'flex-end',top:47,right:20,alignItems:'center'}}>
        <Image
