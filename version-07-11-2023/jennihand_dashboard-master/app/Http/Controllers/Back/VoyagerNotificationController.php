...
class VoyagerNotificationController extends \TCG\Voyager\Http\Controllers\VoyagerBaseController
{
    ...
    public function store(Request $request)
    {
        ...
        if($type == 'buyer')
        {
            ...
            foreach($users as $user){
                Notification::send($user, new PushNotification(\Request::input('title'),\Request::input('message'), $user->push_token), \Illuminate\Support\Facades\Auth::id());
            }
